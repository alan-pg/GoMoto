-- ============================================================
-- Migration: preenche customer_id nas billings que só têm lease_id
-- e atualiza os RPCs para sempre gravar customer_id no INSERT.
-- ============================================================

-- 1. Backfill: cobranças criadas via RPC não tinham customer_id
UPDATE billings b
SET customer_id = r.customer_id
FROM rentals r
WHERE b.lease_id  = r.id
  AND b.customer_id IS NULL;

-- ============================================================
-- 2. Reescreve create_rental_with_charges com customer_id no INSERT
-- ============================================================
...
BEGIN
  ...
  -- Bulk insert de cobranças incluindo customer_id
...
-- ============================================================
-- 3. Reescreve renew_rental com customer_id nos INSERTs
-- ============================================================
...
BEGIN
  ...
  -- Busca customer_id da locação para denormalizar nas cobranças
